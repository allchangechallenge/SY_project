...
//[start-20210903-fei 0105- mod]//

				// postRotation = new THREE.Quaternion().setFromEuler( postRotation ).invert();
				postRotation = new THREE.Quaternion().setFromEuler( postRotation ).getInverse();
//[end-20210903-fei 0105- mod]//
...
//[start-20210903-fei 0105- mod]//
		console.log(' 111111111  ',  lParentGSM.copy( lParentGRM ).getInverse()     );
		// lParentGSM.copy( lParentGRM ).invert().multiply( lParentGX );
		lParentGSM.copy( lParentGRM ).getInverse().multiply( lParentGX );
...
//[start-20210903-fei 0105- mod]//
			...
			lParentLSM_inv.copy( lScalingM ).getInverse();
//[end-20210903-fei 0105- mod]//
...
//[start-20210903-fei 0105- mod]//
		...
		// lRotationPivotM_inv.copy( lRotationPivotM ).getInverse();
//[end-20210903-fei 0105- mod]//
		var lScalingPivotM_inv = new THREE.Matrix4();
//[start-20210903-fei 0105- mod]//
		// lScalingPivotM_inv.copy( lScalingPivotM ).invert();
		lScalingPivotM_inv.copy( lScalingPivotM ).getInverse();
//[end-20210903-fei 0105- mod]//
